...
struct GameModeConfig: Equatable {
    ...
    var wineESync = true
    var wineMSync = true
    var engineName: String? = SikarugirEngine.availableEngineNames().first { $0.localizedCaseInsensitiveContains("sikarugir") }
        ?? SikarugirEngine.availableEngineNames().first
