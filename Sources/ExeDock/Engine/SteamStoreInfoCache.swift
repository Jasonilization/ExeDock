...
actor SteamStoreInfoCache {
    ...
    private func fetchFromNetwork(_ appID: String) async -> SteamStoreInfo? {
        ...
        guard description?.isEmpty == false || headerImagePath != nil else { return nil }
    ...
    private func downloadHeaderImage(_ url: URL, appID: String) async -> String? {
        ...
        guard (try? FileManager.default.moveItem(at: tempURL, to: URL(fileURLWithPath: destination))) != nil else {
            return nil
        }
        return destination
    }
